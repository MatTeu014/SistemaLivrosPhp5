        ...
        <header id="header"><!--Inicio Header-->
            ...
            <nav id="nav"><!--Inicio nav-->
                ...
                <div id="botoesBloco"><!--Inicio botoesBloco-->
                    <button class="botao"><a  href="TelaLogin.php" style="color: white;">Entrar</a></button><!--Botao-->
                    <button class="botao"><a  href="TelaCadastrar.php" style="color: white;">Cadastrar</a></button><!--Botao-->
                </div><!--Fim botoesBloco-->
